...
public class ViciontGuisClient implements ClientModInitializer {
    ...
    // ==========================================
    // EJEMPLOS DE OVERLAYS (HUD e Inventario)
    // ==========================================
    public static String getHudEjemploJson() {
        return """
        {
          "gui_id": "hud_test",
          "target": "hud",
    ...
    public static String getInvEjemploJson() {
        return """
            {
              "gui_id": "inv_test",
              "target": "inventory",
    ...
    private static String getCambiosJson() {
        ...
        return "{ \"gui_id\": \"menu_cambios\", \"background\": { \"texture\": \"viciontguis:textures/gui/fondo_cambios.png\", \"width\": 370, \"height\": 304 }, \"elements\": [ " + String.join(",\n", elements) + " ] }";
    }

    private static String getCambioLecturaJson(int n) {
        String mensaje = cambiosMensajes.getOrDefault(n, "[\"\",{\"text\":\"Todavia no hay informacion sobre este cambio.\",\"color\":\"gray\"}]");
        boolean leido = cambiosLeidos.getOrDefault(n, false);
        List<String> elements = new ArrayList<>();
        ...
        if (leido) elements.add("{ \"id\": \"visto\", \"type\": \"text\", \"text\": \"\u2714\", \"x\": 0, \"y\": 88, \"color\": \"#55FF55\", \"scale\": 1.4, \"bold\": true }");
        elements.add("{ \"id\": \"hint\", \"type\": \"text\", \"text\": \"Dale click para confirmar lectura\", \"x\": 0, \"y\": 112, \"color\": \"#AAAAAA\", \"scale\": 0.7 }");
        return "{ \"gui_id\": \"overlay_cambio_lectura\", \"background\": { \"texture\": \"viciontguis:textures/gui/fondo_cambios_lectura.png\", \"width\": 340, \"height\": 260 }, \"elements\": [ " + String.join(",\n", elements) + " ] }";
    }
    ...
    private static String getEntidadesJson() {
        return """
        {
          ...
          "background": {
            "texture": "viciontguis:textures/gui/fondo_entidades.png", "width": 370, "height": 304
          },
          "elements": [
            { "id": "btn_back", "type": "custom_button", "texture": "viciontguis:textures/gui/flecha_menu_anterior.png", "action": "open_main", "x": -136, "y": -105, "width": 35, "height": 36, "tooltip": [{"text": "Volver al Menú Principal", "color": "#FFFFFF"}] },
            { "id": "btn_prev", "type": "custom_button", "texture": "viciontguis:textures/gui/flecha_izq.png", "action": "prev_page", "x": -49, "y": 122, "width": 35, "height": 36 },
            { "id": "btn_next", "type": "custom_button", "texture": "viciontguis:textures/gui/flecha_der.png", "action": "next_page", "x": 49, "y": 122, "width": 35, "height": 36 },

            { "id": "e1", "type": "entity", "entity_id": "minecraft:zombie", "entity_name": "Corrupted Zombie", "entity_scale": 24, "texture": "viciontguis:textures/gui/entidad_descubierta.png", "x": -126, "y": -20, "width": 58, "height": 81, "tooltip": [{"text": "Corrupted Zombie", "color": "#550055", "bold": true}, {"text": ""}, {"text": "Daño de ataque: 3", "color": "#AAAAAA"}, {"text": "Vida: 20", "color": "#AAAAAA"}, {"text": ""}, {"text": "Este mob tiene la capacidad de lanzar", "color": "#FFFFFF"}, {"text": "wind charg", "color": "#FFFFFF"}, {"text": ""}, {"text": "Al impactar con una entidad da Veneno I y Debilidad I", "color": "#FFFFFF"}] },
            { "id": "e2", "type": "entity", "entity_id": "minecraft:spider", "entity_name": "Corrupted Spider", "entity_scale": 22, "texture": "viciontguis:textures/gui/entidad_descubierta.png", "x": -63, "y": -20, "width": 58, "height": 81, "tooltip": [{"text": "Corrupted Spider", "color": "#550055", "bold": true}, {"text": ""}, {"text": "Daño de ataque: 3", "color": "#AAAAAA"}, {"text": "Vida: 20", "color": "#AAAAAA"}, {"text": ""}, {"text": "Esta araña al atacar a un jugador le genera", "color": "#FFFFFF"}, {"text": "una telaraña en sus pies, se puede evitar usando", "color": "#FFFFFF"}, {"text": "un escudo", "color": "#FFFFFF"}] },
            { "id": "e3", "type": "entity", "entity_id": "minecraft:endermite", "entity_name": "Corrupted Insect", "entity_scale": 41, "texture": "viciontguis:textures/gui/entidad_descubierta.png", "x": 0, "y": -20, "width": 58, "height": 81, "tooltip": [{"text": "Corrupted Insect", "color": "#550055", "bold": true}, {"text": ""}, {"text": "Daño de ataque: 3", "color": "#AAAAAA"}, {"text": "Vida: 25", "color": "#AAAAAA"}, {"text": ""}, {"text": "Este mob de vez en cuando lanza unas esporas", "color": "#FFFFFF"}, {"text": "en área que deja veneno y te tapa la pantalla.", "color": "#FFFFFF"}] },
            { "id": "e4", "type": "custom_button", "texture": "viciontguis:textures/gui/entidad_no_descubierta.png", "x": 63, "y": -20, "width": 58, "height": 81, "tooltip": [{"text": "Entidad no descubierta.", "color": "#A0A0A0"}] },
            { "id": "e5", "type": "custom_button", "texture": "viciontguis:textures/gui/entidad_no_descubierta.png", "x": 126, "y": -20, "width": 58, "height": 81, "tooltip": [{"text": "Entidad no descubierta.", "color": "#A0A0A0"}] },
        ...
        return """
            {
              "gui_id": "menu_recetas",
              "background": {
                "texture": "viciontguis:textures/gui/fondo_recetas.png", "width": 370, "height": 304
              },
              "elements": [
                { "id": "btn_back", "type": "custom_button", "texture": "viciontguis:textures/gui/flecha_menu_anterior.png", "action": "open_main", "x": -136, "y": -105, "width": 35, "height": 36, "tooltip": [{"text": "Volver al Menú Principal", "color": "#FFFFFF"}] },
                { "id": "btn_prev", "type": "custom_button", "texture": "viciontguis:textures/gui/flecha_izq.png", "action": "prev_page", "x": -49, "y": 122, "width": 35, "height": 36 },
                ...
                { "id": "r1", "type": "item_slot", "texture": "viciontguis:textures/gui/marco_item.png", "item_id": "minecraft:cooked_beef", "custom_model_data": 2, "x": -109, "y": -28, "width": 35, "height": 36, "action": "view_recipe_corrupted_steak", "tooltip": [ {"text": "Carne Corrupta", "color": "#AA00AA", "bold": true} ] },
                { "id": "r2", "type": "item_slot", "texture": "viciontguis:textures/gui/marco_item.png", "item_id": "minecraft:netherite_scrap", "custom_model_data": 5, "x": -65, "y": -28, "width": 35, "height": 36, "action": "view_recipe_corrupted_scrap", "tooltip": [ {"text": "Corrupted Netherite Scrap", "color": "#AA00AA", "bold": true} ] },
                { "id": "r3", "type": "item_slot", "texture": "viciontguis:textures/gui/marco_item.png", "item_id": "minecraft:netherite_helmet", "x": -22, "y": -28, "width": 35, "height": 36, "action": "view_recipe_netherite_helmet", "tooltip": [ {"text": "Netherite Helmet", "color": "#FFFFFF"} ] },
                { "id": "r4", "type": "item_slot", "texture": "viciontguis:textures/gui/marco_item.png", "item_id": "minecraft:netherite_chestplate", "custom_model_data": 2, "x": 22, "y": -28, "width": 35, "height": 36, "action": "view_recipe_runic_chestplate", "tooltip": [ {"text": "Corrupted Netherite Chestplate", "color": "#9966ff", "bold": true} ] },
        ...
        return """
            {
              ...
              "background": {
                "texture": "viciontguis:textures/gui/fondo_misiones.png", "width": 370, "height": 304
              },
              "elements": [
                { "id": "btn_back", "type": "custom_button", "texture": "viciontguis:textures/gui/flecha_menu_anterior.png", "action": "open_main", "x": -136, "y": -105, "width": 35, "height": 36, "tooltip": [{"text": "Volver al Menú Principal", "color": "#FFFFFF"}] },
                { "id": "btn_prev", "type": "custom_button", "texture": "viciontguis:textures/gui/flecha_izq.png", "action": "prev_page", "x": -49, "y": 122, "width": 35, "height": 36 },
                ...
                { "id": "m1", "type": "custom_button", "texture": "viciontguis:textures/gui/misiones_completadas.png", "x": -109, "y": -22, "width": 35, "height": 36, "tooltip": [{"text": "Misión 1", "color": "#90EE90"}, {"text": "Consigue la Armadura", "color": "#D3D3D3"}, {"text": ""}, {"text": "✔ Completada", "color": "#98FB98"}, {"text": ""}, {"text": "Progreso de armadura:", "color": "#F0E68C"}, {"text": "- Casco de Diamante", "color": "#98FB98"}] },
                { "id": "m2", "type": "custom_button", "texture": "viciontguis:textures/gui/misiones_completadas.png", "x": -54, "y": -22, "width": 35, "height": 36, "tooltip": [{"text": "Misión 2", "color": "#90EE90"}, {"text": "Encanta la armadura", "color": "#D3D3D3"}, {"text": ""}, {"text": "✔ Completada", "color": "#98FB98"}] },
                { "id": "m3", "type": "custom_button", "texture": "viciontguis:textures/gui/misiones_no_completadas.png", "x": 0, "y": -22, "width": 35, "height": 36, "tooltip": [{"text": "Misión 6", "color": "#FFB6C1"}, {"text": "Mata Entidades Corruptas", "color": "#D3D3D3"}, {"text": ""}, {"text": "✖ Pendiente", "color": "#FFA07A"}, {"text": ""}, {"text": "Progreso de eliminaciones:", "color": "#F0E68C"}, {"text": "- Corrupted Zombies: 10/25", "color": "#DDA0DD"}] },
                { "id": "m4", "type": "custom_button", "texture": "viciontguis:textures/gui/misiones_no_completadas.png", "x": 54, "y": -22, "width": 35, "height": 36, "tooltip": [{"text": "Misión 12", "color": "#FFB6C1"}, {"text": "Busca Bombitas", "color": "#D3D3D3"}, {"text": ""}, {"text": "✖ Pendiente", "color": "#FFA07A"}, {"text": ""}, {"text": "Progreso de eliminaciones:", "color": "#F0E68C"}, {"text": "- Bombitas: 0/30", "color": "#DDA0DD"}] },
                { "id": "m5", "type": "custom_button", "texture": "viciontguis:textures/gui/misiones_no_descubiertas.png", "x": 109, "y": -22, "width": 35, "height": 36, "tooltip": [{"text": "???", "color": "#A0A0A0"}, {"text": "Misión no descubierta", "color": "#D3D3D3"}] },
    ...
    private static String getRecipeOverlayCraftingTable() {
        return "{ \"gui_id\": \"overlay_crafting\", \"background\": { \"texture\": \"viciontguis:textures/gui/fondo_crafteos.png\", \"width\": 340, \"height\": 260 }, \"elements\": [ { \"id\": \"bg_close\", \"type\": \"invisible_button\", \"action\": \"open_recetas\", \"x\": 0, \"y\": 0, \"width\": 2000, \"height\": 2000 }, { \"id\": \"titulo\", \"type\": \"text\", \"text\": \"Mesa de Crafteo\", \"x\": 0, \"y\": -100, \"color\": \"#FFFFFF\", \"scale\": 1.6, \"bold\": true }, { \"id\": \"i1\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -88, \"y\": -10, \"width\": 32, \"height\": 32, \"tooltip\": [{\"text\": \"Corrupted Meat\", \"color\": \"#AAAAAA\"}] }, { \"id\": \"i2\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -52, \"y\": -10, \"width\": 32, \"height\": 32 }, { \"id\": \"i3\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -16, \"y\": -10, \"width\": 32, \"height\": 32 }, { \"id\": \"i4\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -88, \"y\": 26, \"width\": 32, \"height\": 32 }, { \"id\": \"i5\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:cooked_beef\", \"x\": -52, \"y\": 26, \"width\": 32, \"height\": 32, \"tooltip\": [{\"text\": \"Cooked Beef\", \"color\": \"#FFFFFF\"}] }, { \"id\": \"i6\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -16, \"y\": 26, \"width\": 32, \"height\": 32 }, { \"id\": \"i7\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -88, \"y\": 62, \"width\": 32, \"height\": 32 }, { \"id\": \"i8\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -52, \"y\": 62, \"width\": 32, \"height\": 32 }, { \"id\": \"i9\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:rotten_flesh\", \"custom_model_data\": 2, \"x\": -16, \"y\": 62, \"width\": 32, \"height\": 32 }, { \"id\": \"arrow\", \"type\": \"image\", \"texture\": \"viciontguis:textures/gui/flecha_der.png\", \"x\": 32, \"y\": 26, \"width\": 24, \"height\": 24 }, { \"id\": \"res\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:cooked_beef\", \"custom_model_data\": 2, \"x\": 84, \"y\": 26, \"width\": 40, \"height\": 40, \"tooltip\": [{\"text\": \"Carne Corrupta\", \"color\": \"#AA00AA\", \"bold\": true}] } ] }";
    }

    private static String getRecipeOverlayFurnace() {
        return "{ \"gui_id\": \"overlay_furnace\", \"background\": { \"texture\": \"viciontguis:textures/gui/fondo_crafteos.png\", \"width\": 340, \"height\": 260 }, \"elements\": [ { \"id\": \"bg_close\", \"type\": \"invisible_button\", \"action\": \"open_recetas\", \"x\": 0, \"y\": 0, \"width\": 2000, \"height\": 2000 }, { \"id\": \"titulo\", \"type\": \"text\", \"text\": \"Horno\", \"x\": 0, \"y\": -100, \"color\": \"#FFFFFF\", \"scale\": 1.6, \"bold\": true }, { \"id\": \"input\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:ancient_debris\", \"custom_model_data\": 5, \"x\": -60, \"y\": -16, \"width\": 32, \"height\": 32, \"tooltip\": [{\"text\": \"Corrupted Ancient Debris\", \"color\": \"#990066\", \"bold\": true}] }, { \"id\": \"fuel\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:coal\", \"x\": -60, \"y\": 32, \"width\": 32, \"height\": 32, \"tooltip\": [{\"text\": \"Coal\", \"color\": \"#FFFFFF\"}] }, { \"id\": \"arrow\", \"type\": \"image\", \"texture\": \"viciontguis:textures/gui/flecha_der.png\", \"x\": 0, \"y\": 8, \"width\": 24, \"height\": 24 }, { \"id\": \"res\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:netherite_scrap\", \"custom_model_data\": 5, \"x\": 60, \"y\": 8, \"width\": 40, \"height\": 40, \"tooltip\": [{\"text\": \"Corrupted Netherite Scrap\", \"color\": \"#AA00AA\", \"bold\": true}] } ] }";
    }

    private static String getRecipeOverlaySmithing() {
        return "{ \"gui_id\": \"overlay_smithing\", \"background\": { \"texture\": \"viciontguis:textures/gui/fondo_crafteos.png\", \"width\": 340, \"height\": 260 }, \"elements\": [ { \"id\": \"bg_close\", \"type\": \"invisible_button\", \"action\": \"open_recetas\", \"x\": 0, \"y\": 0, \"width\": 2000, \"height\": 2000 }, { \"id\": \"titulo\", \"type\": \"text\", \"text\": \"Mesa de Herreria\", \"x\": 0, \"y\": -100, \"color\": \"#FFFFFF\", \"scale\": 1.6, \"bold\": true }, { \"id\": \"template\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:netherite_upgrade_smithing_template\", \"x\": -90, \"y\": 8, \"width\": 32, \"height\": 32, \"tooltip\": [{\"text\": \"Netherite Upgrade\", \"color\": \"#FFFFFF\"}] }, { \"id\": \"armor\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:diamond_helmet\", \"x\": -50, \"y\": 8, \"width\": 32, \"height\": 32, \"tooltip\": [{\"text\": \"Diamond Helmet\", \"color\": \"#FFFFFF\"}] }, { \"id\": \"ingot\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:netherite_ingot\", \"x\": -10, \"y\": 8, \"width\": 32, \"height\": 32, \"tooltip\": [{\"text\": \"Netherite Ingot\", \"color\": \"#FFFFFF\"}] }, { \"id\": \"arrow\", \"type\": \"image\", \"texture\": \"viciontguis:textures/gui/flecha_der.png\", \"x\": 40, \"y\": 8, \"width\": 24, \"height\": 24 }, { \"id\": \"res\", \"type\": \"item_slot\", \"texture\": \"viciontguis:textures/gui/marco_item.png\", \"item_id\": \"minecraft:netherite_helmet\", \"x\": 90, \"y\": 8, \"width\": 40, \"height\": 40, \"tooltip\": [{\"text\": \"Netherite Helmet\", \"color\": \"#FFFFFF\"}] } ] }";
    }
